...
def main():
    ...
    #Control parameters
    #kRohHighDistance = 0.6
    #kAlphaHighDistance = 6.5
    #kBetaHighDistance = -4

    kRohHighDistance = 0.5
    kAlphaHighDistance = 6.5
    kBetaHighDistance = -4   
    
    kRohShortDistance = 0.05
    kAlphaShortDistance = 0.2
    kBetaShortDistance = -.1   
    sleepTime = 0.05
    ...
    while robot.isConnected():
        ...
        if (deltaX < 0.12  and deltaY < 0.12):
            print 'short'
            K = setControlMatrix(kRohShortDistance,kAlphaShortDistance,kBetaShortDistance,r,l)
        else:
            print 'high'
            K = setControlMatrix(kRohHighDistance,kAlphaHighDistance,kBetaHighDistance,r,l)
...
def setControlMatrix(kRoh,kAlpha,kBeta,r,l):
